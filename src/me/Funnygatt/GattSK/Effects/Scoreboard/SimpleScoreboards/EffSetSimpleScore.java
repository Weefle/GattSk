...
public class EffSetSimpleScore extends Effect{
	...
	public boolean init(Expression<?>[] args, int arg1, Kleenean arg2,
		...
		this.scoreName = (Expression<String>) args[2];
	...
	protected void execute(Event arg0) {
		...
		if (board == null | namescore == null| score == null) {
			return;
		}
		SimpleScoreboard.setScore(board, score.intValue(), namescore);
