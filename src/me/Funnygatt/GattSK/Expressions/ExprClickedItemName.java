 ...
 */
public class ExprClickedItemName extends SimpleExpression<String> {
	protected String[] get(Event event)
	{
		return Collect.asArray(((InventoryClickEvent)event).getCurrentItem().getItemMeta().getDisplayName());
	}
